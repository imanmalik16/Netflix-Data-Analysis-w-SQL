...
-- 14. Find each year's number of content released in the United States on Netflix, along with each years % of all U.S. content added, sorted from most to least.
